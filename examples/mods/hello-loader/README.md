...
[Guide home](../../../docs/MOD_AUTHORING.md) | [Descriptor](evejs-launcher.mod.json) | [Loader source](loader.js.disabled)
...
The descriptor is optional for a legacy loader but supplies a stable public ID and display name. Rename the example ID/folder before developing a real mod. See [legacy loading patterns](../../../docs/mod-authoring/legacy.md) before adding EveJS-specific hooks.
