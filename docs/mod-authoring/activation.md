...
For this loader, the manifest uses the following fields. Other mod kinds have different activation contracts; see the [1. Make your first package](first-mod.md).
