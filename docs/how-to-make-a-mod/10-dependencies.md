...
Enable the dependent mod without its prerequisite: the launcher should name the missing mod. Then install and enable the prerequisite and retry. [1. Make your first package](01-first-mod.md).
